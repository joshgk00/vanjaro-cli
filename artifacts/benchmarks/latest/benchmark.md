...
| `template_top1_accuracy` | 0.8800 (22/25) |
| `template_top3_accuracy` | 0.9600 (24/25) |
...
| `html-bootstrap-agency` | `template_top1_accuracy` | `northstar.nav` | `["new:global-navbar"]` | `"footer-4col"` | selected template is not an acceptable annotated match |
| `html-bootstrap-agency` | `template_top3_accuracy` | `northstar.nav` | `["new:global-navbar"]` | `["footer-4col", "footer-3col", "stats-grid-4up"]` | top three omit every acceptable annotated match |
