...
| `responsive_observation_coverage` | 0.8636 (38/44) |
| `template_top1_accuracy` | 1.0000 (25/25) |
| `template_top3_accuracy` | 1.0000 (25/25) |
| `high_confidence_precision` | 1.0000 (19/19) |
...
| `figma-freeform-nonprofit` | `responsive_observation_coverage` | `riverkind.hero` | `false` | `null` | responsive observation is missing or differs |
