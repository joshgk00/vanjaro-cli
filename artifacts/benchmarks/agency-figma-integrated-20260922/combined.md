...
| `responsive_observation_coverage` | 0.8636 (38/44) | 1.0000 (6/6) |
| `template_top1_accuracy` | 1.0000 (25/25) | 1.0000 (2/2) |
| `template_top3_accuracy` | 1.0000 (25/25) | 1.0000 (2/2) |
| `high_confidence_precision` | 1.0000 (19/19) | 1.0000 (2/2) |

## Corpus status

- `design-benchmarks`: passed (threshold failures: 0, regression failures: 0)
- `design-image-benchmarks`: passed (threshold failures: 0, regression failures: 0)
